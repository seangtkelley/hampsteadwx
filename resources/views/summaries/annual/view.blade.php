        ...
        <script>
            ...
            function drawAvgChart() {
                ...
                dataTable.addRows([
                    ...
                    foreach ($monthlyObs as $ob) {
                        $str .= "['" . substr(date('F', mktime(0, 0, 0, $ob->month, 10)), 0, 3) . "'," . $ob->avg . "," . $ob->depart_temp_avg;
            ...
            function drawPrecipChart() {
                ...
                dataTable.addRows([
                    ...
                    $str = "";
                    foreach ($monthlyObs as $ob) {
                        $str .= "['" . substr(date('F', mktime(0, 0, 0, $ob->month, 10)), 0, 3) . "'," . $ob->total_precip . "," . ($ob->total_precip - $avg_precip_array[$ob->month - 1]);
            ...
            function drawGrtsPrecipChart() {
                ...
                dataTable.addRows([
                    ...
                    foreach ($monthlyObs as $ob) {
                        ...
                        $str .= "['" . substr(date('F', mktime(0, 0, 0, $ob->month, 10)), 0, 3) . "'," . (($ob->grts_precip == -77) ? 0.01 : $ob->grts_precip) . ",'" . $tooltip . "'";
            ...
            function drawSnowfallChart() {
                ...
                dataTable.addRows([
                    ...
                    $str = "";
                    foreach ($monthlyObs as $ob) {
                        $tooltip = "<div style=\"margin: 5px;\"><h4 style=\"border-bottom: 1px solid grey;\">" . substr(date('F', mktime(0, 0, 0, $ob->month, 10)), 0, 3) . "</h4>" . ($ob->total_sf == -77 ? 'Trace' : $ob->total_sf) . "</div>";
                        $str .= "['" . substr(date('F', mktime(0, 0, 0, $ob->month, 10)), 0, 3) . "'," . (($ob->total_sf == -77) ? 0.01 : $ob->total_sf) . ",'" . $tooltip . "'";
            ...
            function drawSnowDepthChart() {
                ...
                dataTable.addRows([
                    ...
                    $str = "";
                    foreach ($monthlyObs as $ob) {
                        $tooltip = "<div style=\"margin: 5px;\"><h4 style=\"border-bottom: 1px solid grey;\">" . substr(date('F', mktime(0, 0, 0, $ob->month, 10)), 0, 3) . "</h4>" . ($ob->grts_sd == -77 ? 'Trace' : $ob->grts_sd) . "</div>";
                        $str .= "['" . substr(date('F', mktime(0, 0, 0, $ob->month, 10)), 0, 3) . "'," . (($ob->grts_sd == -77) ? 0.01 : $ob->grts_sd) . ",'" . $tooltip . "'";
        ...
        @if(!is_null($year))
            <div class="row better-row">
                ...
                <div id="summaryBtns" class="col-xs-12 col-sm-12 col-md-12 col-lg-12"
                    ...
                    <a href="{{route('summaries.annual.home')}}" class="btn btn-info" style="margin-bottom: 3px"><span
                    ...
                    <a href="{{route('summaries.annual.text', ['year' => $year])}}" target="_blank"
                       class="btn btn-primary" style="margin-bottom: 3px"><span class="glyphicon glyphicon-save-file" aria-hidden="true"></span>&nbsp;
                        Open Text Summary</a>
                    <a href="{{route('summaries.annual.table', ['year' => $year])}}" target="_blank"
                       class="btn btn-primary" style="margin-bottom: 3px"><span class="glyphicon glyphicon-th" aria-hidden="true"></span>&nbsp;
                        Open Table Summary</a>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"
                     style="min-height: 5px; border-top: 1px solid grey;"></div>
